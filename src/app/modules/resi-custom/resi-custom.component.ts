...
@Component({
  selector: "app-resi-custom",
  templateUrl: "./resi-custom.component.html",
})
export class ResiCustomComponent {
  constructor(
    ...
    this.currentModule = store.configuration.modules.filter(
      (module: { moduleName: string }) => module.moduleName === "resi-custom"
    )[0].moduleConfig;
  ...
  products: any = {};
  selected: any;
  formResiCustom!: UntypedFormGroup;
  choices: any;
  choiceText!: string;
  choiceLink?: any;
