...
export class NavbarComponent implements OnInit {
  ...
  currentTheme = this.themes[5];
  // currentTheme = "bg-gradient-to-r from-indigo-500 via-cyan-400 to-green-500";
  ...
  setTheme() {
    ...
    // this.currentTheme = this.themes[this.themeIndex];
    (this.currentTheme = `bg-gradient-to-br from-${
      this.colors2.names[Math.floor(Math.random() * this.colors2.names.length)]
    }-${
      this.colors2.tone[Math.floor(Math.random() * this.colors2.tone.length)]
    } to-${
      this.colors2.names[Math.floor(Math.random() * this.colors2.names.length)]
    }-${
      this.colors2.tone[Math.floor(Math.random() * this.colors2.tone.length)]
